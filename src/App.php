...
use Forgge\Cli\Commands\AssetsBuild;
use Forgge\Cli\Commands\CreateConfigJson;
use Forgge\Cli\Commands\Install;
use Forgge\Cli\Commands\InstallCarbonFields;
use Forgge\Cli\Commands\InstallCleanComposer;
use Forgge\Cli\Commands\InstallCssFramework;
use Forgge\Cli\Commands\InstallDependencies;
use Forgge\Cli\Commands\InstallFontAwesome;
use Forgge\Cli\Commands\InstallPhpTests;
use Forgge\Cli\Commands\MakeController;
use Forgge\Cli\Commands\MakeServiceProvider;
use Forgge\Cli\Commands\MakeViewComposer;
...
class App {
	...
	public static function create() {
		$composer = Composer::getComposerJson( FORGGE_CLI_DIR );

		$application = new Application( 'Forgge CLI', $composer['version'] );
